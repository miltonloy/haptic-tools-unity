...
namespace Leap.Unity
{
    ...
    public class HapticHand : IHandModel
    {
        ...
        private static Color[] _leftColorList = { new Color(0.0f, 0.0f, 0.0f) };
        //private static Color[] _rightColorList = { new Color(1.0f, 0.0f, 0.0f), new Color(1.0f, 1.0f, 0.0f), new Color(1.0f, 0.5f, 0.0f) };
        private static Color[] _rightColorList = { new Color(0.0f, 0.0f, 0.0f) };
        ...
        private Color _cNeutral = new Color(1.0f, 1.0f, 1.0f);
        private Color _cPositive = Color.red;
        private Color _cNegative = Color.blue;
        private Color _cNothing = new Color(0.3f, 0.3f, 0.3f, 1f);
        ...
        */
        ...
        Color GetActuatorColor(float value)
        {
            Color result = _cNeutral;
            if (value > 0)
            {
                result = Color.Lerp(_cNeutral, _cPositive, value / 1.5f);
            } else
            {
                result = Color.Lerp(_cNeutral, _cNegative, value / -1.5f);
            }
            return result;
        }
